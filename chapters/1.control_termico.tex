...
Obtener mediciónes de temperatura de dos sensores ubicados en el exterior del sistema principal, verificar si pasan un umbral y tomar las medidas necesariasa.

\subsection{Implementación}

\subsubsection*{Simulaciónes}

\paragraph{Planteo matemático}
...
\paragraph{Simulación en LTSPice}
...
\paragraph{Resultados simulación}
...
\subsubsection{Análisis y consideraciones de diseño}
...
\subsubsection{Evaluación de la etapa de control térmico}
