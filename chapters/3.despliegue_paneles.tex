...
\begin{figure}[H]
  ...
  \caption{Circuito comparador analógico}%
  \label{fig:esquema de comparación}
\end{figure}
...
\subsubsection*{Comparador: selectora}

\begin{figure}[H]
  \includegraphics[max width=0.9\linewidth]{graphics/selectora.png}
  \caption{Circuito selector con panel indicadorl}%
